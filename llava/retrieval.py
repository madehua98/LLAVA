...
# train_path = '/mnt/data_llm/172_train_path.json'
# test_path = '/mnt/data_llm/172_test_path.json'

# data_list = load_json('/mnt/data_llm/food172_embeddings.json')
...
#     retrieval_category.append({test_path: sorted_categories})
